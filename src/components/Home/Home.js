...
const Home = () => {
    ...
    const handleSearch = async () => {
        ...
        if (foundCountry) {
            ...
            try {
                const response = await axios.get(`https://restcountries.com/v2/alpha/${foundCountry.alpha2Code}`);
                setSelectedCountry({ ...foundCountry, ...response.data }); // Merge country details
            } catch (error) {
